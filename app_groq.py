...
llm = ChatGroq(temperature=0.7,model_name= "llama3-8b-8192",callbacks=[StreamingStdOutCallbackHandler()],groq_api_key=api_key)
...
# streamlit run rag_with_memory.py --server.port 8085
# streamlit run rag_with_memory.py --server.fileWatcherType None --server.port 8085 
